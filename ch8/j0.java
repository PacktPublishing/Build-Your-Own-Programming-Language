...
public class j0 {
   ...
   public static ch8.parser par;
   public static ch8.symtab global_st;
  ...
  public static void semantic(parserVal r) {
    ...
    ch8.symtab out_st, System_st;
    global_st = new ch8.symtab("global");
    System_st = new ch8.symtab("class");
    out_st = new ch8.symtab("class");
