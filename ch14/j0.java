...
public class j0 {
   ...
   public static ch14.parser par;
   public static ch14.symtab global_st, stringtab;
  ...
  public static void semantic(parserVal r) {
    ...
    ch14.symtab out_st, System_st;
    global_st = new ch14.symtab("global");
    stringtab = new ch14.symtab("strings");
    System_st = new ch14.symtab("class");
    out_st = new ch14.symtab("class");
...
public static ArrayList<x64> x64code(ArrayList<tac> icode)
{
    ...
    for(int i=0; i<icode.size(); i++) {
      ...
      case "SADD": {
	  xcode.addAll(xgen("movq", instr.op2, "%rdi"));
	  xcode.addAll(xgen("movq", instr.op3, "%rsi"));
	  xcode.addAll(xgen("call", "j0concat"));
	  xcode.addAll(xgen("movq", "%rax", instr.op1));
	  break;
      }
