...
public class j0 {
   ...
   public static ch16.parser par;
   public static ch16.symtab global_st, stringtab;
  ...
  public static void semantic(parserVal r) {
    ...
    ch16.symtab out_st, System_st;
    global_st = new ch16.symtab("global");
    stringtab = new ch16.symtab("strings");
    System_st = new ch16.symtab("class");
    out_st = new ch16.symtab("class");
